...
* Storage
  ...
  - Data (training data, validation data, checkpoints) in ${SD_DATA_DIR} (`/hps/data/mlperf_training/stable_diffusion`)
...
1. Set environment variables.  Replace the paths below with your own if necessary.
   ...
   export SD_DATA_DIR=/hps/data/mlperf_training/stable_diffusion
